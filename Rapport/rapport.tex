...
\begin{document}
  ...
  \end{titlepage}
	...
	Pour déplacer la caméra à hauteur fixe, on va devoir déplacer la caméra uniquement sur les axes x et y. On va devoir utiliser les matrices (et plus précisément des translations) pour faire bouger la caméra.\\
	...
	\lstinputlisting[language=C++, firstline=227, lastline=229, caption=Exemple où on regarde si la touche échappe est celle pressée]{../mainwidget.cpp}
